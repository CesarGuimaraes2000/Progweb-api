...
export default function TorrentFormDestroy(){
    ...
    const onSubmit = (e) =>{
        e.preventDefault();
        axiosClient.delete(`/torrent/destroy/${id}`)
            .then(()=>{
             setTorrent({});
        ...
        <Fragment>
            <div className = "display">
                <div className="card animated fadeinDown">
                    {torrent.id && <h1>Exclusão de Torrent: {torrent.titulo}</h1>}
                    <form onSubmit={(e) => onSubmit(e)}>
                        <input defaultValue={torrent.titulo} placeholder="Título" readOnly={true}/>
                        <input defaultValue={torrent.descricao} placeholder="Descricao"readOnly={true}/>
